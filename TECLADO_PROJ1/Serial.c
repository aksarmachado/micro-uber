...
void serial_init() {
	...
	UCSR0B = (1<<RXEN0) | (1<<TXEN0) | (1<<RXCIE0);	 // pinos 4, 3 e 7 - Habilita recep��o, transmiss�o serial e interrup��o por recep��o serial da serial  0
...
{
	while (!(UCSR0A & (1 << UDRE0))); //Enquanto o buffer de transmiss�o de dados n�o estiver vazio UDR0 ainda n�o escreve os dados para transmitir
	UDR0 = dado_transmitido;
}


// Fun��o que transmite um conjunto de bytes da serial, entrada � o vetor serial a ser lido e o tamanho do vetor (numero de bytes)
void transmite_string_serial(char *dado_transmitir, int tamanho) // essa fun��o vai transmitir estado para display ou interface
{
	int i;
